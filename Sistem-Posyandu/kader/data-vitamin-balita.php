...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Pemberian Vitamin Balita Datatable</h5>
      <a class="mt-2 btn btn-info text-white" href="view-data-vitamin-balita-bulan-ini.php">
      ...
      <a class="mt-2 btn btn-success text-white" onclick="openModal()" style="cursor:pointer;">
        <i class="fas me-2 fa-download"></i> Ekspor Excel
      </a><br><br>
        ...
        <table id="zero_config" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $blt['nama_ibu'] ?></td>
              <td>
                <a class="btn btn-secondary m-1" href="view-data-vitamin-balita.php?idbalita=<?= $blt['id'] ?>"><i class="fas fa-eye"></i> Lihat Data</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="adddataLabel">Tambah data Vitamin Balita</h1>
        ...
        <div class="modal-body" id="editmodal">
          <form action="../function/add-data.php" method="post">
            <div class="form-group">
              ...
              <input readonly type="hidden" name="id" id="idbalita" class="form-control">
              <input readonly type="text" name="nama" id="nama" class="form-control">
            </div>
            <div class="form-group">
              <label>Tanggal Posyandu *</label>
              <input required type="date" name="tanggal" class="form-control" aria-describedby="tanggal">
            </div>
            <div class="form-group">
              <label>Nama/Jenis Vitamin *</label>
              <input type="text" name="nama_vitamin" class="form-control" required>
            </div>
            
            <div class="text-center mt-3"></div>
            <button type="submit" class="btn btn-info" name="add-vitamin">Simpan</button>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id="editmodal">
          <form action="../function/export-excel.php" method="post" target="__blank">
            ...
            <div class="text-center mt-3"></div>
            <button type="submit" class="btn btn-info" name="ekspor-vitamin">Ekspor</button>
            <div class="btn btn-primary" data-bs-dismiss="modal" aria-label="Close">Close</div>
          </form>
        </div>
      </div>  
