...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Pemberian Vitamin <?= $bulan ?> <?= $year ?> </h5>
      <a class="mt-2 btn btn-info text-white float-md-start"  href="data-vitamin-balita.php">
      ...
      <form class=" mt-2 ms-2 float-md-start" action="../function/export-excel.php" method="post" target="__blank">
        ...
        <button class="btn text-white btn-success" name="ekspor-vitamin"><i class="fas me-2 fa-download"></i> Ekspor Excel</button>
      </form>
      ...
      <div class="table-responsive">
        <table id="zero_config" class="table table-striped table-bordered">
          ...
          <?php
            ...
            $cekdate = mysqli_query($conn, "SELECT uk.id_balita, uk.id, uk.nama_vitamin, uk.tanggal, uk.bulan, uk.tahun, bal.nama FROM data_vitamin as uk JOIN balita as bal ON uk.id_balita = bal.id WHERE uk.bulan = '".$bulan."' AND uk.tahun = ".$year);
          ?>
          <tbody>
        ...
        <div class="modal-body" id="editmodal">
          <form action="../function/update-data.php" method="post">
            ...
            <div class="form-group">
              ...
              <input required type="text" id="nama_vitamin" name="nama_vitamin" class="form-control">
            </div>
...
<script type="text/javascript">
  ...
  function viewData(id){
    ...
    $.ajax({
        url : '../function/show-data.php?vitamincuscekid='+id,
        method: 'GET',
